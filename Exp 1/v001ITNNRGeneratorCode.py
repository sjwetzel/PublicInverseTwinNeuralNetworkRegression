...
np.savez("ITNNR_generator_results.npz", ITNNR_mse_list=np.array(collect_ITNNR_mse_list), kNN_mse_list=np.array(collect_kNN_mse_list),best_ITNNR_mse=np.array(collect_best_ITNNR_mse))
